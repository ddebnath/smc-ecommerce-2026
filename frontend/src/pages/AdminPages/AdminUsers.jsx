...
const AdminUsers = () => {
  ...
  const stats = {
    ...
    productOwners: users.filter((u) => u.role === "productOwner").length,
  ...
  return (
    <div className="pl-[350px] py-20 mx-auto px-6">
      <h1 className="text-2xl font-bold mb-10 text-center">All Users</h1>
      {/* ================= USER STATS ================= */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
          ...
          <p className="text-xl font-bold text-blue-700">{stats.admins}</p>
        </div>

        <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          <p className="text-sm text-green-600">Product Owners</p>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-center">
          <p className="text-sm text-yellow-600">Users</p>
